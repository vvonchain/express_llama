...
__export(src_exports, {
  ...
  DEFAULT_IMAGE_VECTOR_NAMESPACE: () => DEFAULT_IMAGE_VECTOR_NAMESPACE,
...
var InMemoryFileSystem = class {
  ...
  writeFile(path7, content, options) {
    return __async(this, null, function* () {
      this.files[path7] = import_lodash.default.cloneDeep(content);
    });
  }
  readFile(path7, options) {
    return __async(this, null, function* () {
      ...
      return import_lodash.default.cloneDeep(this.files[path7]);
    });
  }
  access(path7) {
    return __async(this, null, function* () {
  ...
  mkdir(path7, options) {
    return __async(this, null, function* () {
      this.files[path7] = import_lodash.default.get(this.files, path7, null);
    });
  }
};
function getNodeFS() {
...
var ImageNode = class extends TextNode {
  ...
  getUrl() {
    const absPath = import_path.default.resolve(this.id_);
...
var AstraDBVectorStore = class {
  constructor(init) {
    ...
    if (init == null ? void 0 : init.astraDBClient) {
      ...
      this.astraDBClient = new import_astra_db_ts.AstraDB(token, endpoint);
    }
...
function imageToString(input) {
  return __async(this, null, function* () {
    ...
    } else if (import_lodash5.default.isString(input)) {
      return input;
...
function imageToDataUrl(input) {
  return __async(this, null, function* () {
    if (input instanceof URL && input.protocol === "file:" || import_lodash5.default.isString(input)) {
