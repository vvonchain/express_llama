...
/*!********************!*\
  !*** ./src/env.js ***!
  \********************/(e,t,n)=>{n.r(t),n.d(t,{env:()=>m});var r=n(/*! fs */"?569f"),o=n(/*! path */"?3f59"),i=n(/*! url */"?154a"),s=n(/*! ./backends/onnx.js */"./src/backends/onnx.js");const{env:a}=s.ONNX,l="2.13.4",c="undefined"!=typeof self&&"caches"in self,u=!b(r),d=!b(o),p=u&&d,_=p?o.dirname(o.dirname(i.fileURLToPath("file:///home/runner/work/transformers.js/transformers.js/src/env.js"))):"./",h=p?o.join(_,"/.cache/"):null,f="/models/",g=p?o.join(_,f):f;a.wasm.wasmPaths=p?o.join(_,"/dist/"):`https://cdn.jsdelivr.net/npm/@xenova/transformers@${l}/dist/`;const m={backends:{onnx:a,tfjs:{}},__dirname:_,version:l,allowRemoteModels:!0,remoteHost:"https://huggingface.co/",remotePathTemplate:"{model}/resolve/{revision}/",allowLocalModels:!0,localModelPath:g,useFS:u,useBrowserCache:c,useFSCache:u,cacheDir:h,useCustomCache:!1,customCache:null};function b(e){return 0===Object.keys(e).length}},"./src/models.js":
/*!***********************!*\
  !*** ./src/models.js ***!
  \***********************/(e,t,n)=>{n.r(t),n.d(t,{ASTForAudioClassification:()=>Qt,ASTModel:()=>Yt,ASTPreTrainedModel:()=>Xt,AlbertForMaskedLM:()=>it,AlbertForQuestionAnswering:()=>ot,AlbertForSequenceClassification:()=>rt,AlbertModel:()=>nt,AlbertPreTrainedModel:()=>tt,AutoModel:()=>gi,AutoModelForAudioClassification:()=>Di,AutoModelForCTC:()=>Ii,AutoModelForCausalLM:()=>vi,AutoModelForDepthEstimation:()=>zi,AutoModelForDocumentQuestionAnswering:()=>Li,AutoModelForImageClassification:()=>Pi,AutoModelForImageMatting:()=>$i,AutoModelForImageSegmentation:()=>Ai,AutoModelForImageToImage:()=>Ni,AutoModelForMaskGeneration:()=>Ei,AutoModelForMaskedLM:()=>ki,AutoModelForObjectDetection:()=>Ci,AutoModelForQuestionAnswering:()=>Mi,AutoModelForSemanticSegmentation:()=>Fi,AutoModelForSeq2SeqLM:()=>wi,AutoModelForSequenceClassification:()=>mi,AutoModelForSpeechSeq2Seq:()=>yi,AutoModelForTextToSpectrogram:()=>xi,AutoModelForTextToWaveform:()=>Ti,AutoModelForTokenClassification:()=>bi,AutoModelForVision2Seq:()=>Si,AutoModelForZeroShotObjectDetection:()=>Oi,BartForConditionalGeneration:()=>mt,BartForSequenceClassification:()=>bt,BartModel:()=>gt,BartPretrainedModel:()=>ft,BaseModelOutput:()=>B,BeitForImageClassification:()=>ar,BeitModel:()=>sr,BeitPreTrainedModel:()=>ir,BertForMaskedLM:()=>V,BertForQuestionAnswering:()=>q,BertForSequenceClassification:()=>G,BertForTokenClassification:()=>U,BertModel:()=>j,BertPreTrainedModel:()=>R,BlenderbotForConditionalGeneration:()=>St,BlenderbotModel:()=>Mt,BlenderbotPreTrainedModel:()=>kt,BlenderbotSmallForConditionalGeneration:()=>Ft,BlenderbotSmallModel:()=>At,BlenderbotSmallPreTrainedModel:()=>Pt,BloomForCausalLM:()=>jn,BloomModel:()=>Rn,BloomPreTrainedModel:()=>Bn,CLIPModel:()=>nn,CLIPPreTrainedModel:()=>tn,CLIPSegForImageSegmentation:()=>hn,CLIPSegModel:()=>_n,CLIPSegPreTrainedModel:()=>pn,CLIPTextModelWithProjection:()=>rn,CLIPVisionModelWithProjection:()=>on,CamembertForMaskedLM:()=>pe,CamembertForQuestionAnswering:()=>fe,CamembertForSequenceClassification:()=>_e,CamembertForTokenClassification:()=>he,CamembertModel:()=>de,CamembertPreTrainedModel:()=>ue,CausalLMOutput:()=>Ui,CausalLMOutputWithPast:()=>qi,ChineseCLIPModel:()=>dn,ChineseCLIPPreTrainedModel:()=>un,ClapAudioModelWithProjection:()=>Lo,ClapModel:()=>Io,ClapPreTrainedModel:()=>Eo,ClapTextModelWithProjection:()=>Do,CodeGenForCausalLM:()=>En,CodeGenModel:()=>On,CodeGenPreTrainedModel:()=>Cn,ConvBertForMaskedLM:()=>ee,ConvBertForQuestionAnswering:()=>re,ConvBertForSequenceClassification:()=>te,ConvBertForTokenClassification:()=>ne,ConvBertModel:()=>J,ConvBertPreTrainedModel:()=>Z,ConvNextForImageClassification:()=>Rr,ConvNextModel:()=>Br,ConvNextPreTrainedModel:()=>zr,ConvNextV2ForImageClassification:()=>Gr,ConvNextV2Model:()=>Vr,ConvNextV2PreTrainedModel:()=>jr,DPTForDepthEstimation:()=>Er,DPTModel:()=>Or,DPTPreTrainedModel:()=>Cr,DebertaForMaskedLM:()=>be,DebertaForQuestionAnswering:()=>xe,DebertaForSequenceClassification:()=>we,DebertaForTokenClassification:()=>ye,DebertaModel:()=>me,DebertaPreTrainedModel:()=>ge,DebertaV2ForMaskedLM:()=>ke,DebertaV2ForQuestionAnswering:()=>Pe,DebertaV2ForSequenceClassification:()=>Me,DebertaV2ForTokenClassification:()=>Se,DebertaV2Model:()=>ve,DebertaV2PreTrainedModel:()=>Te,DeiTForImageClassification:()=>yr,DeiTModel:()=>wr,DeiTPreTrainedModel:()=>br,DetrForObjectDetection:()=>ur,DetrForSegmentation:()=>dr,DetrModel:()=>cr,DetrObjectDetectionOutput:()=>pr,DetrPreTrainedModel:()=>lr,DetrSegmentationOutput:()=>_r,Dinov2ForImageClassification:()=>Wr,Dinov2Model:()=>qr,Dinov2PreTrainedModel:()=>Ur,DistilBertForMaskedLM:()=>Ie,DistilBertForQuestionAnswering:()=>Ee,DistilBertForSequenceClassification:()=>Ce,DistilBertForTokenClassification:()=>Oe,DistilBertModel:()=>Fe,DistilBertPreTrainedModel:()=>Ae,DonutSwinModel:()=>Nr,DonutSwinPreTrainedModel:()=>$r,ElectraForMaskedLM:()=>se,ElectraForQuestionAnswering:()=>ce,ElectraForSequenceClassification:()=>ae,ElectraForTokenClassification:()=>le,ElectraModel:()=>ie,ElectraPreTrainedModel:()=>oe,EsmForMaskedLM:()=>$e,EsmForSequenceClassification:()=>Ne,EsmForTokenClassification:()=>ze,EsmModel:()=>Le,EsmPreTrainedModel:()=>De,FalconForCausalLM:()=>Oo,FalconModel:()=>Co,FalconPreTrainedModel:()=>Fo,GLPNForDepthEstimation:()=>Lr,GLPNModel:()=>Dr,GLPNPreTrainedModel:()=>Ir,GPT2LMHeadModel:()=>mn,GPT2Model:()=>gn,GPT2PreTrainedModel:()=>fn,GPTBigCodeForCausalLM:()=>Fn,GPTBigCodeModel:()=>An,GPTBigCodePreTrainedModel:()=>Pn,GPTJForCausalLM:()=>Sn,GPTJModel:()=>Mn,GPTJPreTrainedModel:()=>kn,GPTNeoForCausalLM:()=>yn,GPTNeoModel:()=>wn,GPTNeoPreTrainedModel:()=>bn,GPTNeoXForCausalLM:()=>vn,GPTNeoXModel:()=>Tn,GPTNeoXPreTrainedModel:()=>xn,HubertForCTC:()=>_o,HubertForSequenceClassification:()=>ho,HubertModel:()=>po,HubertPreTrainedModel:()=>uo,ImageMattingOutput:()=>Wi,LlamaForCausalLM:()=>Ln,LlamaModel:()=>Dn,LlamaPreTrainedModel:()=>In,LongT5ForConditionalGeneration:()=>dt,LongT5Model:()=>ut,LongT5PreTrainedModel:()=>ct,M2M100ForConditionalGeneration:()=>io,M2M100Model:()=>oo,M2M100PreTrainedModel:()=>ro,MBartForCausalLM:()=>vt,MBartForConditionalGeneration:()=>xt,MBartForSequenceClassification:()=>Tt,MBartModel:()=>yt,MBartPreTrainedModel:()=>wt,MPNetForMaskedLM:()=>We,MPNetForQuestionAnswering:()=>Ye,MPNetForSequenceClassification:()=>He,MPNetForTokenClassification:()=>Xe,MPNetModel:()=>qe,MPNetPreTrainedModel:()=>Ue,MT5ForConditionalGeneration:()=>ht,MT5Model:()=>_t,MT5PreTrainedModel:()=>pt,MarianMTModel:()=>no,MarianModel:()=>to,MarianPreTrainedModel:()=>eo,MaskedLMOutput:()=>Vi,MistralForCausalLM:()=>Ao,MistralModel:()=>Po,MistralPreTrainedModel:()=>So,MobileBertForMaskedLM:()=>je,MobileBertForQuestionAnswering:()=>Ge,MobileBertForSequenceClassification:()=>Ve,MobileBertModel:()=>Re,MobileBertPreTrainedModel:()=>Be,MobileViTForImageClassification:()=>tr,MobileViTModel:()=>er,MobileViTPreTrainedModel:()=>Jn,ModelOutput:()=>z,MptForCausalLM:()=>Un,MptModel:()=>Gn,MptPreTrainedModel:()=>Vn,OPTForCausalLM:()=>Hn,OPTModel:()=>Wn,OPTPreTrainedModel:()=>qn,OwlViTForObjectDetection:()=>or,OwlViTModel:()=>rr,OwlViTPreTrainedModel:()=>nr,PhiForCausalLM:()=>zn,PhiModel:()=>Nn,PhiPreTrainedModel:()=>$n,PreTrainedModel:()=>N,PretrainedMixin:()=>Vo,QuestionAnsweringModelOutput:()=>Gi,ResNetForImageClassification:()=>vr,ResNetModel:()=>Tr,ResNetPreTrainedModel:()=>xr,RoFormerForMaskedLM:()=>X,RoFormerForQuestionAnswering:()=>K,RoFormerForSequenceClassification:()=>Y,RoFormerForTokenClassification:()=>Q,RoFormerModel:()=>H,RoFormerPreTrainedModel:()=>W,RobertaForMaskedLM:()=>Et,RobertaForQuestionAnswering:()=>Lt,RobertaForSequenceClassification:()=>It,RobertaForTokenClassification:()=>Dt,RobertaModel:()=>Ot,RobertaPreTrainedModel:()=>Ct,SamImageSegmentationOutput:()=>Jr,SamModel:()=>Zr,SamPreTrainedModel:()=>Kr,SegformerForImageClassification:()=>Ro,SegformerForSemanticSegmentation:()=>jo,SegformerModel:()=>Bo,SegformerPreTrainedModel:()=>zo,Seq2SeqLMOutput:()=>Bi,SequenceClassifierOutput:()=>Ri,SiglipModel:()=>an,SiglipPreTrainedModel:()=>sn,SiglipTextModel:()=>ln,SiglipVisionModel:()=>cn,SpeechT5ForSpeechToText:()=>xo,SpeechT5ForTextToSpeech:()=>To,SpeechT5HifiGan:()=>vo,SpeechT5Model:()=>yo,SpeechT5PreTrainedModel:()=>wo,SqueezeBertForMaskedLM:()=>Ze,SqueezeBertForQuestionAnswering:()=>et,SqueezeBertForSequenceClassification:()=>Je,SqueezeBertModel:()=>Ke,SqueezeBertPreTrainedModel:()=>Qe,Swin2SRForImageSuperResolution:()=>Fr,Swin2SRModel:()=>Ar,Swin2SRPreTrainedModel:()=>Pr,SwinForImageClassification:()=>Sr,SwinModel:()=>Mr,SwinPreTrainedModel:()=>kr,T5ForConditionalGeneration:()=>lt,T5Model:()=>at,T5PreTrainedModel:()=>st,TableTransformerForObjectDetection:()=>gr,TableTransformerModel:()=>fr,TableTransformerObjectDetectionOutput:()=>mr,TableTransformerPreTrainedModel:()=>hr,TokenClassifierOutput:()=>ji,TrOCRForCausalLM:()=>Mo,TrOCRPreTrainedModel:()=>ko,ViTForImageClassification:()=>Qn,ViTModel:()=>Yn,ViTPreTrainedModel:()=>Xn,VisionEncoderDecoderModel:()=>en,VitMatteForImageMatting:()=>Zn,VitMattePreTrainedModel:()=>Kn,VitsModel:()=>No,VitsModelOutput:()=>Hi,VitsPreTrainedModel:()=>$o,Wav2Vec2ForCTC:()=>lo,Wav2Vec2ForSequenceClassification:()=>co,Wav2Vec2Model:()=>ao,Wav2Vec2PreTrainedModel:()=>so,WavLMForCTC:()=>mo,WavLMForSequenceClassification:()=>bo,WavLMModel:()=>go,WavLMPreTrainedModel:()=>fo,WhisperForConditionalGeneration:()=>Jt,WhisperModel:()=>Zt,WhisperPreTrainedModel:()=>Kt,XLMForQuestionAnswering:()=>jt,XLMForSequenceClassification:()=>Bt,XLMForTokenClassification:()=>Rt,XLMModel:()=>Nt,XLMPreTrainedModel:()=>$t,XLMRobertaForMaskedLM:()=>Ut,XLMRobertaForQuestionAnswering:()=>Ht,XLMRobertaForSequenceClassification:()=>qt,XLMRobertaForTokenClassification:()=>Wt,XLMRobertaModel:()=>Gt,XLMRobertaPreTrainedModel:()=>Vt,XLMWithLMHeadModel:()=>zt,YolosForObjectDetection:()=>Yr,YolosModel:()=>Xr,YolosObjectDetectionOutput:()=>Qr,YolosPreTrainedModel:()=>Hr});var r=n(/*! ./configs.js */"./src/configs.js"),o=n(/*! ./utils/core.js */"./src/utils/core.js"),i=n(/*! ./utils/hub.js */"./src/utils/hub.js"),s=n(/*! ./utils/generation.js */"./src/utils/generation.js"),a=n(/*! ./utils/tensor.js */"./src/utils/tensor.js"),l=n(/*! ./backends/onnx.js */"./src/backends/onnx.js"),c=n(/*! ./transformers.js */"./src/transformers.js");const{InferenceSession:u,Tensor:d,env:p}=l.ONNX,_=0,h=1,f=2,g=3,m=4,b=new Map,w=new Map,y=new Map;async function x(e,t,n){let r=`onnx/${t}${n.quantized?"_quantized":""}.onnx`,o=await(0,i.getModelFile)(e,r,!0,n);try{return await u.create(o,{executionProviders:l.executionProviders})}catch(e){if(1===l.executionProviders.length&&"wasm"===l.executionProviders[0])throw e;return console.warn(e),console.warn("Something went wrong during model construction (most likely a missing operation). Using `wasm` as a fallback. "),await u.create(o,{executionProviders:["wasm"]})}}async function T(e,t){const n=function(e,t){const n=Object.create(null),r=[];for(const o of e.inputNames){const e=t[o];e instanceof a.Tensor?n[o]=p.wasm.proxy?e.clone():e:r.push(o)}if(r.length>0)throw new Error(`An error occurred during model execution: "Missing the following inputs: ${r.join(", ")}.`);const o=Object.keys(t).length,i=e.inputNames.length;if(o>i){let n=Object.keys(t).filter((t=>!e.inputNames.includes(t)));console.warn(`WARNING: Too many inputs were provided (${o} > ${i}). The following inputs will be ignored: "${n.join(", ")}".`)}return n}(e,t);try{let t=await e.run(n);return t=v(t),t}catch(e){throw console.error(`An error occurred during model execution: "${e}".`),console.error("Inputs given to model:",n),e}}function v(e){for(let t in e)e[t]instanceof d?e[t]=new a.Tensor(e[t]):"object"==typeof e[t]&&v(e[t]);return e}function k(e){if(e instanceof a.Tensor)return e;if(0===e.length)throw Error("items must be non-empty");if(Array.isArray(e[0])){if(e.some((t=>t.length!==e[0].length)))throw Error("Unable to create tensor, you should probably activate truncation and/or padding with 'padding=True' and/or 'truncation=True' to have batched tensors with the same length.");return new a.Tensor("int64",BigInt64Array.from(e.flat().map((e=>BigInt(e)))),[e.length,e[0].length])}return new a.Tensor("int64",BigInt64Array.from(e.map((e=>BigInt(e)))),[1,e.length])}function M(e,t){let n=e.config.pad_token_id??null,r=e.config.eos_token_id??null;(0,o.isIntegralNumber)(r)&&(r=[r]);let i=-1!==t.indexOf(n),s=null===r||!r.includes(n);if(i&&s){let e=BigInt64Array.from(t.data.map((e=>e!=n)));return new a.Tensor("int64",e,t.dims)}return(0,a.ones_like)(t)}function S(e,t,n){if(!e.inputNames.includes("position_ids"))return;const r=new BigInt64Array(t.attention_mask.data.length);for(let e=0;e<t.attention_mask.dims[0];++e){let n=e*t.attention_mask.dims[1],o=BigInt(0);for(let e=0;e<t.attention_mask.dims[1];++e){const i=n+e;0n===t.attention_mask.data[i]?r[i]=BigInt(1):(r[i]=o,o+=t.attention_mask.data[i])}}t.position_ids=new a.Tensor("int64",r,t.attention_mask.dims),n&&(t.position_ids=t.position_ids.slice(null,-1).unsqueeze_(-1))}function P(e){return new a.Tensor("bool",[e],[1])}async function A(e,t){let{encoder_outputs:n,past_key_values:r}=t;n||(n=(await E(e,t)).last_hidden_state);let o={input_ids:t.decoder_input_ids,encoder_hidden_states:n};const i=!!r;e.decoder_merged_session.inputNames.includes("use_cache_branch")&&(o.use_cache_branch=P(i)),e.decoder_merged_session.inputNames.includes("encoder_attention_mask")&&(o.encoder_attention_mask=t.attention_mask),S(e.decoder_merged_session,o,i),e.addPastKeyValues(o,r);const s=await T(e.decoder_merged_session,o);let a=s.logits;r=e.getPastKeyValues(s,r);const l=e.getAttentions(s);return new Bi({logits:a,past_key_values:r,encoder_outputs:n,...l})}function F(e,t,n,r){let o=[],i=0;const s=e.requires_attention_mask??!0;let l=n.decoder_input_ids??n.decoder_start_token_id??n.bos_token_id??n.eos_token_id;l instanceof a.Tensor?l=l.tolist().flat():Array.isArray(l)||(l=[l]);for(let n of t){n.dims=[1,...n.dims];let t={inputs:n,encoder_outputs:null,prev_model_outputs:null,output_token_ids:l,done:!1,score:0,id:i++};s&&(t.attention_mask=M(e,n)),o.push(t)}return o}async function C(e,t){const n=e.main_input_name;let r=t.output_token_ids;t.prev_model_outputs&&(r=r.slice(-1));let o={[n]:t.inputs,decoder_input_ids:k(r),encoder_outputs:t.encoder_outputs,past_key_values:t.prev_model_outputs?.past_key_values};t.attention_mask&&(o.attention_mask=t.attention_mask);let i=await e.forward(o);return t.prev_model_outputs=i,t.encoder_outputs=i.encoder_outputs,i}function O(e,t){e.output_token_ids=[...e.output_token_ids,t]}async function E(e,t){const n=Object.create(null);for(const r of e.session.inputNames)n[r]=t[r];return e.session.inputNames.includes("token_type_ids")&&!n.token_type_ids&&(n.token_type_ids=new a.Tensor("int64",new BigInt64Array(n.input_ids.data.length),n.input_ids.dims)),await T(e.session,n)}async function I(e,t){let{input_ids:n,past_key_values:r,attention_mask:o}=t,i={input_ids:n,attention_mask:o??M(e,n)};const s=!!r;e.session.inputNames.includes("use_cache_branch")&&(i.use_cache_branch=P(s)),S(e.session,i,s),e.addPastKeyValues(i,r);let a=await T(e.session,i),l=a.logits;return r=e.getPastKeyValues(a,r),{logits:l,past_key_values:r}}function D(e,t,n,r,o){let i=[],s=0;for(let n of t){let t,a=n.tolist().map(Number);n.dims=[1,...n.dims],o?(t=o[s],t.dims=[1,...t.dims]):t=M(e,n);let l={input:n,model_input_ids:n,attention_mask:t,prev_model_outputs:null,output_token_ids:a,num_output_tokens:r,done:!1,score:0,id:s++};i.push(l)}return i}async function L(e,t){let n=new BigInt64Array(t.output_token_ids.length).fill(1n),r={input_ids:t.model_input_ids,attention_mask:new a.Tensor("int64",n,[1,n.length]),past_key_values:t.prev_model_outputs?.past_key_values},o=await e.forward(r);return t.prev_model_outputs=o,o}function $(e,t){e.output_token_ids=[...e.output_token_ids,t],e.model_input_ids=new a.Tensor("int64",[BigInt(t)],[1,1])}class N extends o.Callable{main_input_name="input_ids";constructor(e,t){super(),this.config=e,this.session=t;const n=y.get(this.constructor),r=b.get(n);this.can_generate=!1,this._runBeam=null,this._getStartBeams=null,this._updateBeam=null,this._forward=null,r===m?(this.can_generate=!0,this._runBeam=L,this._getStartBeams=D,this._updateBeam=$,this._forward=I):r===f||r===g?(this.can_generate=!0,this._runBeam=C,this._getStartBeams=F,this._updateBeam=O,this._forward=A):this._forward=E}async dispose(){const e=[];for(let t of Object.keys(this)){const n=this[t];n instanceof u&&e.push(n.handler.dispose())}return await Promise.all(e)}static async from_pretrained(e,{quantized:t=!0,progress_callback:n=null,config:o=null,cache_dir:s=null,local_files_only:a=!1,revision:l="main",model_file_name:c=null}={}){let u={quantized:t,progress_callback:n,config:o,cache_dir:s,local_files_only:a,revision:l,model_file_name:c};const d=y.get(this),p=b.get(d);let w;return p===m?w=await Promise.all([r.AutoConfig.from_pretrained(e,u),x(e,u.model_file_name??"decoder_model_merged",u),(0,i.getModelJSON)(e,"generation_config.json",!1,u)]):p===f||p===g?w=await Promise.all([r.AutoConfig.from_pretrained(e,u),x(e,"encoder_model",u),x(e,"decoder_model_merged",u),(0,i.getModelJSON)(e,"generation_config.json",!1,u)]):p===h?w=await Promise.all([r.AutoConfig.from_pretrained(e,u),x(e,"encoder_model",u),x(e,"decoder_model_merged",u)]):(p!==_&&console.warn(`Model type for '${d}' not found, assuming encoder-only architecture. Please report this at https://github.com/xenova/transformers.js/issues/new/choose.`),w=await Promise.all([r.AutoConfig.from_pretrained(e,u),x(e,u.model_file_name??"model",u)])),new this(...w)}async _call(e){return await this.forward(e)}async forward(e){return await this._forward(this,e)}_get_logits_processor(e,t,n=null){const r=new s.LogitsProcessorList;if(null!==e.repetition_penalty&&1!==e.repetition_penalty&&r.push(new s.RepetitionPenaltyLogitsProcessor(e.repetition_penalty)),null!==e.no_repeat_ngram_size&&e.no_repeat_ngram_size>0&&r.push(new s.NoRepeatNGramLogitsProcessor(e.no_repeat_ngram_size)),null!==e.bad_words_ids&&r.push(new s.NoBadWordsLogitsProcessor(e.bad_words_ids,e.eos_token_id)),null!==e.min_length&&null!==e.eos_token_id&&e.min_length>0&&r.push(new s.MinLengthLogitsProcessor(e.min_length,e.eos_token_id)),null!==e.min_new_tokens&&null!==e.eos_token_id&&e.min_new_tokens>0&&r.push(new s.MinNewTokensLengthLogitsProcessor(t,e.min_new_tokens,e.eos_token_id)),null!==e.forced_bos_token_id&&r.push(new s.ForcedBOSTokenLogitsProcessor(e.forced_bos_token_id)),null!==e.forced_eos_token_id&&r.push(new s.ForcedEOSTokenLogitsProcessor(e.max_length,e.forced_eos_token_id)),null!==e.begin_suppress_tokens){let n=t>1||null===e.forced_bos_token_id?t:t+1;null!==e.forced_decoder_ids&&(n+=e.forced_decoder_ids[e.forced_decoder_ids.length-1][0]),r.push(new s.SuppressTokensAtBeginLogitsProcessor(e.begin_suppress_tokens,n))}return null!==e.forced_decoder_ids&&r.push(new s.ForceTokensLogitsProcessor(e.forced_decoder_ids)),null!==n&&r.extend(n),r}_get_generation_config(e){let t=new s.GenerationConfig(this.config);return"generation_config"in this&&Object.assign(t,this.generation_config),null!==e&&Object.assign(t,e),t}async generate(e,t=null,n=null,{inputs_attention_mask:r=null}={}){if(!this.can_generate){let e=`The current model class (${y.get(this.constructor)}) is not compatible with \`.generate()\`, as it doesn't have a language model head.`;const t=this.config.model_type,n=Zo.get(t)??Ko.get(t)??Wo.get(t)??ti.get(t);throw n&&(e+=` Please use the following class instead: '${n[0]}'`),Error(e)}if(!(e instanceof a.Tensor||(0,o.isTypedArray)(e)||Array.isArray(e)))throw Error(`\`inputs\` must be a Tensor, TypedArray, or Array, but is "${e.constructor.name}".`);let i;if(this.config.is_encoder_decoder)i=0;else if(i=e instanceof a.Tensor?e.dims.at(-1):e.length,0===i)throw Error("Must supply a non-empty array of input token ids.");t=this._get_generation_config(t),n=n??new s.LogitsProcessorList,n=this._get_logits_processor(t,i,n);let l=t.eos_token_id;null===l||Array.isArray(l)||(l=[l]);let c=1;const u=c+(t.max_new_tokens??1/0),d=Number.isInteger(t.max_length)&&null===(t.max_new_tokens??null);let p=s.Sampler.getSampler(t),_=this.getStartBeams(e,t,c,r);for(;_.some((e=>!e.done))&&c<u;){let e=[];for(let r of _){if(r.done){e.push(r);continue}if(d&&r.output_token_ids.length>=t.max_length){r.done=!0,e.push(r);continue}let o=await this.runBeam(r);t.output_attentions&&this.addAttentionsToBeam(r,o),t.output_scores;let i=o.logits.slice(null,-1,null);n(r.output_token_ids,i);let s=p(i);for(let[t,n]of s){let o={...r};this.updateBeam(o,t),o.score+=n,l&&l.includes(t)&&(o.done=!0),e.push(o)}}++c,e=this.groupBeams(e).map((e=>e.sort(((e,t)=>t.score-e.score)).slice(0,t.num_beams))),_=e.flat(),t.callback_function&&t.callback_function(_)}const h=this.groupBeams(_),f=e=>h.map((n=>t.num_return_sequences>1?n.slice(0,t.num_return_sequences).map((t=>t[e])):[n[0][e]])).flat(),g=f("output_token_ids");if(t.return_dict_in_generate){return{sequences:g,decoder_attentions:f("decoder_attentions"),cross_attentions:f("cross_attentions")}}return g}addAttentionsToBeam(e,t){if(this.config.is_encoder_decoder){if(!t.cross_attentions||0===t.cross_attentions.length)throw Error("`output_attentions` is true, but the model did not produce cross-attentions. This is most likely because the model was not exported with `output_attentions=True`.");e.cross_attentions||(e.cross_attentions=[]),e.cross_attentions.push(t.cross_attentions)}if(!t.decoder_attentions||0===t.decoder_attentions.length)throw Error("`output_attentions` is true, but the model did not produce decoder-attentions. This is most likely because the model was not exported with `output_attentions=True`.");e.decoder_attentions||(e.decoder_attentions=[]),e.decoder_attentions.push(t.decoder_attentions)}groupBeams(e){const t=Object.create(null);for(const n of e)void 0===t[n.id]?t[n.id]=[n]:t[n.id].push(n);return Object.values(t)}getPastKeyValues(e,t){const n=Object.create(null);for(const r in e)if(r.startsWith("present")){let o=r.replace("present","past_key_values");t&&r.includes("encoder")?n[o]=t[o]:n[o]=e[r]}return n}getAttentions(e){const t=Object.create(null);for(const n of["cross_attentions","decoder_attentions"]){const r=[];for(const t in e)if(t.startsWith(n)){r[t.split(".").pop()]=e[t]}t[n]=r}return t}addPastKeyValues(e,t){if(t)Object.assign(e,t);else{const t=1;if(this.config.is_encoder_decoder&&(this.add_encoder_pkv??1)){let n=[t,this.num_encoder_heads,0,this.encoder_dim_kv],r=[t,this.num_decoder_heads,0,this.decoder_dim_kv];for(let t=0;t<this.num_decoder_layers;++t)e[`past_key_values.${t}.encoder.key`]=new a.Tensor("float32",[],n),e[`past_key_values.${t}.encoder.value`]=new a.Tensor("float32",[],n),e[`past_key_values.${t}.decoder.key`]=new a.Tensor("float32",[],r),e[`past_key_values.${t}.decoder.value`]=new a.Tensor("float32",[],r)}else if("falcon"===this.config.model_type){let n=[t*this.num_heads,0,this.dim_kv];for(let t=0;t<this.num_layers;++t)e[`past_key_values.${t}.key`]=new a.Tensor("float32",[],n),e[`past_key_values.${t}.value`]=new a.Tensor("float32",[],n)}else if(this.config.multi_query){let n=[t*this.num_heads,0,2*this.dim_kv];for(let t=0;t<this.num_layers;++t)e[`past_key_values.${t}.key_value`]=new a.Tensor("float32",[],n)}else if("bloom"===this.config.model_type){let n=[t*this.num_heads,this.dim_kv,0],r=[t*this.num_heads,0,this.dim_kv];for(let t=0;t<this.num_layers;++t)e[`past_key_values.${t}.key`]=new a.Tensor("float32",[],n),e[`past_key_values.${t}.value`]=new a.Tensor("float32",[],r)}else{let n=[t,this.num_heads,0,this.dim_kv];for(let t=0;t<this.num_layers;++t)e[`past_key_values.${t}.key`]=new a.Tensor("float32",[],n),e[`past_key_values.${t}.value`]=new a.Tensor("float32",[],n)}}}getStartBeams(e,t,n,r){return this._getStartBeams(this,e,t,n,r)}async runBeam(e){return await this._runBeam(this,e)}updateBeam(e,t){return this._updateBeam(e,t)}}class z{}class B extends z{constructor({last_hidden_state:e,hidden_states:t=null,attentions:n=null}){super(),this.last_hidden_state=e,this.hidden_states=t,this.attentions=n}}class R extends N{}class j extends R{}class V extends R{async _call(e){return new Vi(await super._call(e))}}class G extends R{async _call(e){return new Ri(await super._call(e))}}class U extends R{async _call(e){return new ji(await super._call(e))}}class q extends R{async _call(e){return new Gi(await super._call(e))}}class W extends N{}class H extends W{}class X extends W{async _call(e){return new Vi(await super._call(e))}}class Y extends W{async _call(e){return new Ri(await super._call(e))}}class Q extends W{async _call(e){return new ji(await super._call(e))}}class K extends W{async _call(e){return new Gi(await super._call(e))}}class Z extends N{}class J extends Z{}class ee extends Z{async _call(e){return new Vi(await super._call(e))}}class te extends Z{async _call(e){return new Ri(await super._call(e))}}class ne extends Z{async _call(e){return new ji(await super._call(e))}}class re extends Z{async _call(e){return new Gi(await super._call(e))}}class oe extends N{}class ie extends oe{}class se extends oe{async _call(e){return new Vi(await super._call(e))}}class ae extends oe{async _call(e){return new Ri(await super._call(e))}}class le extends oe{async _call(e){return new ji(await super._call(e))}}class ce extends oe{async _call(e){return new Gi(await super._call(e))}}class ue extends N{}class de extends ue{}class pe extends ue{async _call(e){return new Vi(await super._call(e))}}class _e extends ue{async _call(e){return new Ri(await super._call(e))}}class he extends ue{async _call(e){return new ji(await super._call(e))}}class fe extends ue{async _call(e){return new Gi(await super._call(e))}}class ge extends N{}class me extends ge{}class be extends ge{async _call(e){return new Vi(await super._call(e))}}class we extends ge{async _call(e){return new Ri(await super._call(e))}}class ye extends ge{async _call(e){return new ji(await super._call(e))}}class xe extends ge{async _call(e){return new Gi(await super._call(e))}}class Te extends N{}class ve extends Te{}class ke extends Te{async _call(e){return new Vi(await super._call(e))}}class Me extends Te{async _call(e){return new Ri(await super._call(e))}}class Se extends Te{async _call(e){return new ji(await super._call(e))}}class Pe extends Te{async _call(e){return new Gi(await super._call(e))}}class Ae extends N{}class Fe extends Ae{}class Ce extends Ae{async _call(e){return new Ri(await super._call(e))}}class Oe extends Ae{async _call(e){return new ji(await super._call(e))}}class Ee extends Ae{async _call(e){return new Gi(await super._call(e))}}class Ie extends Ae{async _call(e){return new Vi(await super._call(e))}}class De extends N{}class Le extends De{}class $e extends De{async _call(e){return new Vi(await super._call(e))}}class Ne extends De{async _call(e){return new Ri(await super._call(e))}}class ze extends De{async _call(e){return new ji(await super._call(e))}}class Be extends N{}class Re extends Be{}class je extends Be{async _call(e){return new Vi(await super._call(e))}}class Ve extends Be{async _call(e){return new Ri(await super._call(e))}}class Ge extends Be{async _call(e){return new Gi(await super._call(e))}}class Ue extends N{}class qe extends Ue{}class We extends Ue{async _call(e){return new Vi(await super._call(e))}}class He extends Ue{async _call(e){return new Ri(await super._call(e))}}class Xe extends Ue{async _call(e){return new ji(await super._call(e))}}class Ye extends Ue{async _call(e){return new Gi(await super._call(e))}}class Qe extends N{}class Ke extends Qe{}class Ze extends Qe{async _call(e){return new Vi(await super._call(e))}}class Je extends Qe{async _call(e){return new Ri(await super._call(e))}}class et extends Qe{async _call(e){return new Gi(await super._call(e))}}class tt extends N{}class nt extends tt{}class rt extends tt{async _call(e){return new Ri(await super._call(e))}}class ot extends tt{async _call(e){return new Gi(await super._call(e))}}class it extends tt{async _call(e){return new Vi(await super._call(e))}}class st extends N{}class at extends st{}class lt extends st{constructor(e,t,n,r){super(e,t),this.decoder_merged_session=n,this.generation_config=r,this.num_decoder_layers=this.config.num_decoder_layers,this.num_decoder_heads=this.config.num_heads,this.decoder_dim_kv=this.config.d_kv,this.num_encoder_layers=this.config.num_layers,this.num_encoder_heads=this.config.num_heads,this.encoder_dim_kv=this.config.d_kv}}class ct extends N{}class ut extends ct{}class dt extends ct{constructor(e,t,n,r){super(e,t),this.decoder_merged_session=n,this.generation_config=r,this.num_decoder_layers=this.config.num_decoder_layers,this.num_decoder_heads=this.config.num_heads,this.decoder_dim_kv=this.config.d_kv,this.num_encoder_layers=this.config.num_layers,this.num_encoder_heads=this.config.num_heads,this.encoder_dim_kv=this.config.d_kv}}class pt extends N{}class _t extends pt{}class ht extends pt{constructor(e,t,n,r){super(e,t),this.decoder_merged_session=n,this.generation_config=r,this.num_decoder_layers=this.config.num_decoder_layers,this.num_decoder_heads=this.config.num_heads,this.decoder_dim_kv=this.config.d_kv,this.num_encoder_layers=this.config.num_layers,this.num_encoder_heads=this.config.num_heads,this.encoder_dim_kv=this.config.d_kv}}class ft extends N{}class gt extends ft{}class mt extends ft{constructor(e,t,n,r){super(e,t),this.decoder_merged_session=n,this.generation_config=r,this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.d_model/this.num_encoder_heads}}class bt extends ft{async _call(e){return new Ri(await super._call(e))}}class wt extends N{}class yt extends wt{}class xt extends wt{constructor(e,t,n,r){super(e,t),this.decoder_merged_session=n,this.generation_config=r,this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.d_model/this.num_encoder_heads}}class Tt extends wt{async _call(e){return new Ri(await super._call(e))}}class vt extends wt{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.d_model/this.num_encoder_heads}}class kt extends N{}class Mt extends kt{}class St extends kt{constructor(e,t,n,r){super(e,t),this.decoder_merged_session=n,this.generation_config=r,this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.d_model/this.num_encoder_heads}}class Pt extends N{}class At extends Pt{}class Ft extends Pt{constructor(e,t,n,r){super(e,t),this.decoder_merged_session=n,this.generation_config=r,this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.d_model/this.num_encoder_heads}}class Ct extends N{}class Ot extends Ct{}class Et extends Ct{async _call(e){return new Vi(await super._call(e))}}class It extends Ct{async _call(e){return new Ri(await super._call(e))}}class Dt extends Ct{async _call(e){return new ji(await super._call(e))}}class Lt extends Ct{async _call(e){return new Gi(await super._call(e))}}class $t extends N{}class Nt extends $t{}class zt extends $t{async _call(e){return new Vi(await super._call(e))}}class Bt extends $t{async _call(e){return new Ri(await super._call(e))}}class Rt extends $t{async _call(e){return new ji(await super._call(e))}}class jt extends $t{async _call(e){return new Gi(await super._call(e))}}class Vt extends N{}class Gt extends Vt{}class Ut extends Vt{async _call(e){return new Vi(await super._call(e))}}class qt extends Vt{async _call(e){return new Ri(await super._call(e))}}class Wt extends Vt{async _call(e){return new ji(await super._call(e))}}class Ht extends Vt{async _call(e){return new Gi(await super._call(e))}}class Xt extends N{}class Yt extends Xt{}class Qt extends Xt{}class Kt extends N{}class Zt extends Kt{}class Jt extends Kt{requires_attention_mask=!1;main_input_name="input_features";constructor(e,t,n,r){super(e,t),this.decoder_merged_session=n,this.generation_config=r,this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.d_model/this.num_encoder_heads}async generate(e,t=null,n=null){if(t=this._get_generation_config(t),t.return_timestamps??=!1,t.return_timestamps&&(n=[new s.WhisperTimeStampLogitsProcessor(t)]),t.return_token_timestamps&&(t.output_attentions=!0,t.return_dict_in_generate=!0,"translate"===t.task&&console.warn("Token-level timestamps may not be reliable for task 'translate'."),!t.alignment_heads))throw new Error("Model generation config has no `alignment_heads`, token-level timestamps not available. See https://gist.github.com/hollance/42e32852f24243b748ae6bc1f985b13a on how to add this property to the generation config.");const r=await super.generate(e,t,n);return t.return_token_timestamps&&t.alignment_heads&&(r.token_timestamps=this._extract_token_timestamps(r,t.alignment_heads,t.num_frames)),r}_extract_token_timestamps(e,t,n=null,r=.02){if(!e.cross_attentions)throw new Error("Model outputs must contain cross attentions to extract timestamps. This is most likely because the model was not exported with `output_attentions=True`.");let i=this.config.median_filter_width;void 0===i&&(console.warn("Model config has no `median_filter_width`, using default value of 7."),i=7);const s=e.cross_attentions.map((e=>{let r=Array.from({length:this.config.decoder_layers},((t,n)=>(0,a.cat)(e.map((e=>e[n])),2))),o=(0,a.stack)(t.map((([e,t])=>n?r[e].slice(null,t,null,[0,n]):r[e].slice(null,t))));o=o.transpose(1,0,2,3);let[s,l]=(0,a.std_mean)(o,-2,0,!0),u=o.clone();for(let e=0;e<u.dims[0];++e){let t=u[e];for(let n=0;n<t.dims[0];++n){let r=t[n];const o=s[e][n][0],a=l[e][n][0];for(let e=0;e<r.dims[0];++e){let t=r[e];for(let e=0;e<t.data.length;++e)t.data[e]=(t.data[e]-a.data[e])/o.data[e];t.data.set((0,c.medianFilter)(t.data,i))}}}return(0,a.mean)(u,1)})),l=[e.sequences.length,e.sequences[0].length],u=new a.Tensor("float32",new Float32Array(l[0]*l[1]),l);for(let e=0;e<l[0];++e){const t=s[e].neg().squeeze_(0);let[n,i]=(0,a.dynamicTimeWarping)(t),l=Array.from({length:n.length-1},((e,t)=>n[t+1]-n[t])),c=(0,o.mergeArrays)([1],l).map((e=>!!e)),d=[];for(let e=0;e<c.length;++e)c[e]&&d.push(i[e]*r);u[e].data.set(d,1)}return u}}class en extends N{main_input_name="pixel_values";constructor(e,t,n,r){super(e,t),this.decoder_merged_session=n,this.generation_config=r;const o=this.config.encoder,i=this.config.decoder,s=o.model_type;(Go.get(s)??Uo.get(s))||console.warn(`Model type for encoder '${s}' not found, assuming encoder-only architecture. Please report this at https://github.com/xenova/transformers.js/issues/new/choose.`);const a=Zo.get(i.model_type);if(!a)throw new Error(`Unable to construct \`VisionEncoderDecoder\` due to unsupported decoder: "${this.config.decoder.model_type}"`);const l=new(0,a[1])(i,n,r);this.add_encoder_pkv="num_decoder_layers"in l,this.add_encoder_pkv?(this.num_decoder_layers=l.num_decoder_layers,this.num_decoder_heads=l.num_decoder_heads,this.decoder_dim_kv=l.decoder_dim_kv,this.num_encoder_layers=l.num_encoder_layers,this.num_encoder_heads=l.num_encoder_heads,this.encoder_dim_kv=l.encoder_dim_kv):(this.num_layers=l.num_layers,this.num_heads=l.num_heads,this.dim_kv=l.dim_kv)}}class tn extends N{}class nn extends tn{}class rn extends tn{static async from_pretrained(e,t={}){return t.model_file_name??="text_model",super.from_pretrained(e,t)}}class on extends tn{static async from_pretrained(e,t={}){return t.model_file_name??="vision_model",super.from_pretrained(e,t)}}class sn extends N{}class an extends sn{}class ln extends sn{static async from_pretrained(e,t={}){return t.model_file_name??="text_model",super.from_pretrained(e,t)}}class cn extends tn{static async from_pretrained(e,t={}){return t.model_file_name??="vision_model",super.from_pretrained(e,t)}}class un extends N{}class dn extends un{}class pn extends N{}class _n extends pn{}class hn extends pn{}class fn extends N{constructor(e,t,n){super(e,t),this.generation_config=n,this.config.pad_token_id=this.config.eos_token_id,this.num_heads=this.config.n_head,this.num_layers=this.config.n_layer,this.dim_kv=this.config.n_embd/this.num_heads}}class gn extends fn{}class mn extends fn{}class bn extends N{constructor(e,t,n){super(e,t),this.generation_config=n,this.config.pad_token_id=this.config.eos_token_id,this.num_heads=this.config.num_heads,this.num_layers=this.config.num_layers,this.dim_kv=this.config.hidden_size/this.num_heads}}class wn extends bn{}class yn extends bn{}class xn extends N{constructor(e,t,n){super(e,t),this.generation_config=n,this.config.pad_token_id=this.config.eos_token_id,this.num_heads=this.config.num_attention_heads,this.num_layers=this.config.num_hidden_layers,this.dim_kv=this.config.hidden_size/this.num_heads}}class Tn extends xn{}class vn extends xn{}class kn extends N{constructor(e,t,n){super(e,t),this.generation_config=n,this.config.pad_token_id=this.config.eos_token_id,this.num_heads=this.config.n_head,this.num_layers=this.config.n_layer,this.dim_kv=this.config.n_embd/this.num_heads}}class Mn extends kn{}class Sn extends kn{}class Pn extends N{constructor(e,t,n){super(e,t),this.generation_config=n,this.config.pad_token_id=this.config.eos_token_id,this.num_heads=this.config.n_head,this.num_layers=this.config.n_layer,this.dim_kv=this.config.n_embd/this.num_heads}}class An extends Pn{}class Fn extends Pn{}class Cn extends N{constructor(e,t,n){super(e,t),this.generation_config=n,this.config.pad_token_id=this.config.eos_token_id,this.num_heads=this.config.n_head,this.num_layers=this.config.n_layer,this.dim_kv=this.config.n_embd/this.num_heads}}class On extends Cn{}class En extends Cn{}class In extends N{constructor(e,t,n){super(e,t),this.generation_config=n,this.config.pad_token_id=this.config.eos_token_id,this.num_heads=this.config.num_key_value_heads??this.config.num_attention_heads,this.num_layers=this.config.num_hidden_layers,this.dim_kv=this.config.hidden_size/this.config.num_attention_heads}}class Dn extends In{}class Ln extends In{}class $n extends N{constructor(e,t,n){super(e,t),this.generation_config=n,this.config.pad_token_id=this.config.eos_token_id,this.num_heads=this.config.num_attention_heads,this.num_layers=this.config.num_hidden_layers,this.dim_kv=this.config.hidden_size/this.num_heads}}class Nn extends $n{}class zn extends $n{}class Bn extends N{constructor(e,t,n){super(e,t),this.generation_config=n,this.config.pad_token_id=this.config.eos_token_id,this.num_heads=this.config.n_head,this.num_layers=this.config.n_layer,this.dim_kv=this.config.hidden_size/this.num_heads}}class Rn extends Bn{}class jn extends Bn{}class Vn extends N{constructor(e,t,n){super(e,t),this.generation_config=n,this.config.pad_token_id=this.config.eos_token_id,this.num_heads=this.config.n_heads,this.num_layers=this.config.n_layers,this.dim_kv=this.config.d_model/this.num_heads}}class Gn extends Vn{}class Un extends Vn{}class qn extends N{constructor(e,t,n){super(e,t),this.generation_config=n,this.config.pad_token_id=this.config.eos_token_id,this.num_heads=this.config.num_attention_heads,this.num_layers=this.config.num_hidden_layers,this.dim_kv=this.config.hidden_size/this.num_heads}}class Wn extends qn{}class Hn extends qn{}class Xn extends N{}class Yn extends Xn{}class Qn extends Xn{async _call(e){return new Ri(await super._call(e))}}class Kn extends N{}class Zn extends Kn{async _call(e){return new Wi(await super._call(e))}}class Jn extends N{}class er extends Jn{}class tr extends Jn{async _call(e){return new Ri(await super._call(e))}}class nr extends N{}class rr extends nr{}class or extends nr{}class ir extends N{}class sr extends ir{}class ar extends ir{async _call(e){return new Ri(await super._call(e))}}class lr extends N{}class cr extends lr{}class ur extends lr{async _call(e){return new pr(await super._call(e))}}class dr extends lr{async _call(e){return new _r(await super._call(e))}}class pr extends z{constructor({logits:e,pred_boxes:t}){super(),this.logits=e,this.pred_boxes=t}}class _r extends z{constructor({logits:e,pred_boxes:t,pred_masks:n}){super(),this.logits=e,this.pred_boxes=t,this.pred_masks=n}}class hr extends N{}class fr extends hr{}class gr extends hr{async _call(e){return new mr(await super._call(e))}}class mr extends pr{}class br extends N{}class wr extends br{}class yr extends br{async _call(e){return new Ri(await super._call(e))}}class xr extends N{}class Tr extends xr{}class vr extends xr{async _call(e){return new Ri(await super._call(e))}}class kr extends N{}class Mr extends kr{}class Sr extends kr{async _call(e){return new Ri(await super._call(e))}}class Pr extends N{}class Ar extends Pr{}class Fr extends Pr{}class Cr extends N{}class Or extends Cr{}class Er extends Cr{}class Ir extends N{}class Dr extends Ir{}class Lr extends Ir{}class $r extends N{}class Nr extends $r{}class zr extends N{}class Br extends zr{}class Rr extends zr{async _call(e){return new Ri(await super._call(e))}}class jr extends N{}class Vr extends jr{}class Gr extends jr{async _call(e){return new Ri(await super._call(e))}}class Ur extends N{}class qr extends Ur{}class Wr extends Ur{async _call(e){return new Ri(await super._call(e))}}class Hr extends N{}class Xr extends Hr{}class Yr extends Hr{async _call(e){return new Qr(await super._call(e))}}class Qr extends z{constructor({logits:e,pred_boxes:t}){super(),this.logits=e,this.pred_boxes=t}}class Kr extends N{}class Zr extends Kr{async _call(e){return new Jr(await super._call(e))}}class Jr extends z{constructor({iou_scores:e,pred_masks:t}){super(),this.iou_scores=e,this.pred_masks=t}}class eo extends N{}class to extends eo{}class no extends eo{constructor(e,t,n,r){super(e,t),this.decoder_merged_session=n,this.generation_config=r,this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.d_model/this.num_encoder_heads}}class ro extends N{}class oo extends ro{}class io extends ro{constructor(e,t,n,r){super(e,t),this.decoder_merged_session=n,this.generation_config=r,this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.d_model/this.num_encoder_heads}}class so extends N{}class ao extends so{}class lo extends so{async _call(e){return new Ui(await super._call(e))}}class co extends so{async _call(e){return new Ri(await super._call(e))}}class uo extends N{}class po extends so{}class _o extends so{async _call(e){return new Ui(await super._call(e))}}class ho extends so{async _call(e){return new Ri(await super._call(e))}}class fo extends N{}class go extends fo{}class mo extends fo{async _call(e){return new Ui(await super._call(e))}}class bo extends fo{async _call(e){return new Ri(await super._call(e))}}class wo extends N{}class yo extends wo{}class xo extends wo{}class To extends wo{constructor(e,t,n,r){super(e,t),this.decoder_merged_session=n,this.generation_config=r,this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.hidden_size/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.hidden_size/this.num_encoder_heads}async generate_speech(e,t,{threshold:n=.5,minlenratio:r=0,maxlenratio:o=20,vocoder:i=null}={}){const s={input_ids:e},{encoder_outputs:l,encoder_attention_mask:c}=await E(this,s),u=l.dims[1]/this.config.reduction_factor,d=Math.floor(u*o),p=Math.floor(u*r),_=this.config.num_mel_bins;let h=[],f=null,g=null,m=0;for(;;){++m;const e=P(!!g);let r;r=g?g.output_sequence_out:new a.Tensor("float32",new Float32Array(_),[1,1,_]);let o={use_cache_branch:e,output_sequence:r,encoder_attention_mask:c,speaker_embeddings:t,encoder_hidden_states:l};this.addPastKeyValues(o,f),g=await T(this.decoder_merged_session,o),f=this.getPastKeyValues(g,f);const{prob:i,spectrum:s}=g;if(h.push(s),m>=p&&(Array.from(i.data).filter((e=>e>=n)).length>0||m>=d))break}const b=(0,a.cat)(h),{waveform:w}=await T(i.session,{spectrogram:b});return{spectrogram:b,waveform:w}}}class vo extends N{main_input_name="spectrogram"}class ko extends N{constructor(e,t,n){super(e,t),this.generation_config=n,this.config.pad_token_id=this.config.eos_token_id,this.num_encoder_layers=this.num_decoder_layers=this.config.decoder_layers,this.num_encoder_heads=this.num_decoder_heads=this.config.decoder_attention_heads,this.encoder_dim_kv=this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads}}class Mo extends ko{}class So extends N{constructor(e,t,n){super(e,t),this.generation_config=n,this.config.pad_token_id=this.config.eos_token_id,this.num_heads=this.config.num_key_value_heads,this.num_layers=this.config.num_hidden_layers,this.dim_kv=this.config.hidden_size/this.config.num_attention_heads}}class Po extends So{}class Ao extends So{}class Fo extends N{constructor(e,t,n){super(e,t),this.generation_config=n,this.config.pad_token_id=this.config.eos_token_id,this.num_heads=this.config.num_attention_heads,this.num_layers=this.config.num_hidden_layers,this.dim_kv=this.config.hidden_size/this.config.num_attention_heads}}class Co extends Fo{}class Oo extends Fo{}class Eo extends N{}class Io extends Eo{}class Do extends Eo{static async from_pretrained(e,t={}){return t.model_file_name??="text_model",super.from_pretrained(e,t)}}class Lo extends Eo{static async from_pretrained(e,t={}){return t.model_file_name??="audio_model",super.from_pretrained(e,t)}}class $o extends N{}class No extends $o{async _call(e){return new Hi(await super._call(e))}}class zo extends N{}class Bo extends zo{}class Ro extends zo{}class jo extends zo{}class Vo{static MODEL_CLASS_MAPPINGS=null;static BASE_IF_FAIL=!1;static async from_pretrained(e,{quantized:t=!0,progress_callback:n=null,config:o=null,cache_dir:i=null,local_files_only:s=!1,revision:a="main",model_file_name:l=null}={}){let c={quantized:t,progress_callback:n,config:o,cache_dir:i,local_files_only:s,revision:a,model_file_name:l};if(o=await r.AutoConfig.from_pretrained(e,c),c.config||(c.config=o),!this.MODEL_CLASS_MAPPINGS)throw new Error("`MODEL_CLASS_MAPPINGS` not implemented for this type of `AutoClass`: "+this.name);for(let t of this.MODEL_CLASS_MAPPINGS){const n=t.get(o.model_type);if(n)return await n[1].from_pretrained(e,c)}if(this.BASE_IF_FAIL)return console.warn(`Unknown model class "${o.model_type}", attempting to construct from base class.`),await N.from_pretrained(e,c);throw Error(`Unsupported model type: ${o.model_type}`)}}const Go=new Map([["bert",["BertModel",j]],["roformer",["RoFormerModel",H]],["electra",["ElectraModel",ie]],["esm",["EsmModel",Le]],["convbert",["ConvBertModel",J]],["camembert",["CamembertModel",de]],["deberta",["DebertaModel",me]],["deberta-v2",["DebertaV2Model",ve]],["mpnet",["MPNetModel",qe]],["albert",["AlbertModel",nt]],["distilbert",["DistilBertModel",Fe]],["roberta",["RobertaModel",Ot]],["xlm",["XLMModel",Nt]],["xlm-roberta",["XLMRobertaModel",Gt]],["clap",["ClapModel",Io]],["clip",["CLIPModel",nn]],["clipseg",["CLIPSegModel",_n]],["chinese_clip",["ChineseCLIPModel",dn]],["siglip",["SiglipModel",an]],["mobilebert",["MobileBertModel",Re]],["squeezebert",["SqueezeBertModel",Ke]],["wav2vec2",["Wav2Vec2Model",ao]],["hubert",["HubertModel",po]],["wavlm",["WavLMModel",go]],["audio-spectrogram-transformer",["ASTModel",Yt]],["vits",["VitsModel",No]],["detr",["DetrModel",cr]],["table-transformer",["TableTransformerModel",fr]],["vit",["ViTModel",Yn]],["mobilevit",["MobileViTModel",er]],["owlvit",["OwlViTModel",rr]],["beit",["BeitModel",sr]],["deit",["DeiTModel",wr]],["convnext",["ConvNextModel",Br]],["convnextv2",["ConvNextV2Model",Vr]],["dinov2",["Dinov2Model",qr]],["resnet",["ResNetModel",Tr]],["swin",["SwinModel",Mr]],["swin2sr",["Swin2SRModel",Ar]],["donut-swin",["DonutSwinModel",Nr]],["yolos",["YolosModel",Xr]],["dpt",["DPTModel",Or]],["glpn",["GLPNModel",Dr]],["hifigan",["SpeechT5HifiGan",vo]],["sam",["SamModel",Zr]]]),Uo=new Map([["t5",["T5Model",at]],["longt5",["LongT5Model",ut]],["mt5",["MT5Model",_t]],["bart",["BartModel",gt]],["mbart",["MBartModel",yt]],["marian",["MarianModel",to]],["whisper",["WhisperModel",Zt]],["m2m_100",["M2M100Model",oo]],["blenderbot",["BlenderbotModel",Mt]],["blenderbot-small",["BlenderbotSmallModel",At]]]),qo=new Map([["bloom",["BloomModel",Rn]],["gpt2",["GPT2Model",gn]],["gptj",["GPTJModel",Mn]],["gpt_bigcode",["GPTBigCodeModel",An]],["gpt_neo",["GPTNeoModel",wn]],["gpt_neox",["GPTNeoXModel",Tn]],["codegen",["CodeGenModel",On]],["llama",["LlamaModel",Dn]],["phi",["PhiModel",Nn]],["mpt",["MptModel",Gn]],["opt",["OPTModel",Wn]],["mistral",["MistralModel",Po]],["falcon",["FalconModel",Co]]]),Wo=new Map([["speecht5",["SpeechT5ForSpeechToText",xo]],["whisper",["WhisperForConditionalGeneration",Jt]]]),Ho=new Map([["speecht5",["SpeechT5ForTextToSpeech",To]]]),Xo=new Map([["vits",["VitsModel",No]]]),Yo=new Map([["bert",["BertForSequenceClassification",G]],["roformer",["RoFormerForSequenceClassification",Y]],["electra",["ElectraForSequenceClassification",ae]],["esm",["EsmForSequenceClassification",Ne]],["convbert",["ConvBertForSequenceClassification",te]],["camembert",["CamembertForSequenceClassification",_e]],["deberta",["DebertaForSequenceClassification",we]],["deberta-v2",["DebertaV2ForSequenceClassification",Me]],["mpnet",["MPNetForSequenceClassification",He]],["albert",["AlbertForSequenceClassification",rt]],["distilbert",["DistilBertForSequenceClassification",Ce]],["roberta",["RobertaForSequenceClassification",It]],["xlm",["XLMForSequenceClassification",Bt]],["xlm-roberta",["XLMRobertaForSequenceClassification",qt]],["bart",["BartForSequenceClassification",bt]],["mbart",["MBartForSequenceClassification",Tt]],["mobilebert",["MobileBertForSequenceClassification",Ve]],["squeezebert",["SqueezeBertForSequenceClassification",Je]]]),Qo=new Map([["bert",["BertForTokenClassification",U]],["roformer",["RoFormerForTokenClassification",Q]],["electra",["ElectraForTokenClassification",le]],["esm",["EsmForTokenClassification",ze]],["convbert",["ConvBertForTokenClassification",ne]],["camembert",["CamembertForTokenClassification",he]],["deberta",["DebertaForTokenClassification",ye]],["deberta-v2",["DebertaV2ForTokenClassification",Se]],["mpnet",["MPNetForTokenClassification",Xe]],["distilbert",["DistilBertForTokenClassification",Oe]],["roberta",["RobertaForTokenClassification",Dt]],["xlm",["XLMForTokenClassification",Rt]],["xlm-roberta",["XLMRobertaForTokenClassification",Wt]]]),Ko=new Map([["t5",["T5ForConditionalGeneration",lt]],["longt5",["LongT5ForConditionalGeneration",dt]],["mt5",["MT5ForConditionalGeneration",ht]],["bart",["BartForConditionalGeneration",mt]],["mbart",["MBartForConditionalGeneration",xt]],["marian",["MarianMTModel",no]],["m2m_100",["M2M100ForConditionalGeneration",io]],["blenderbot",["BlenderbotForConditionalGeneration",St]],["blenderbot-small",["BlenderbotSmallForConditionalGeneration",Ft]]]),Zo=new Map([["bloom",["BloomForCausalLM",jn]],["gpt2",["GPT2LMHeadModel",mn]],["gptj",["GPTJForCausalLM",Sn]],["gpt_bigcode",["GPTBigCodeForCausalLM",Fn]],["gpt_neo",["GPTNeoForCausalLM",yn]],["gpt_neox",["GPTNeoXForCausalLM",vn]],["codegen",["CodeGenForCausalLM",En]],["llama",["LlamaForCausalLM",Ln]],["phi",["PhiForCausalLM",zn]],["mpt",["MptForCausalLM",Un]],["opt",["OPTForCausalLM",Hn]],["mbart",["MBartForCausalLM",vt]],["mistral",["MistralForCausalLM",Ao]],["falcon",["FalconForCausalLM",Oo]],["trocr",["TrOCRForCausalLM",Mo]]]),Jo=new Map([["bert",["BertForMaskedLM",V]],["roformer",["RoFormerForMaskedLM",X]],["electra",["ElectraForMaskedLM",se]],["esm",["EsmForMaskedLM",$e]],["convbert",["ConvBertForMaskedLM",ee]],["camembert",["CamembertForMaskedLM",pe]],["deberta",["DebertaForMaskedLM",be]],["deberta-v2",["DebertaV2ForMaskedLM",ke]],["mpnet",["MPNetForMaskedLM",We]],["albert",["AlbertForMaskedLM",it]],["distilbert",["DistilBertForMaskedLM",Ie]],["roberta",["RobertaForMaskedLM",Et]],["xlm",["XLMWithLMHeadModel",zt]],["xlm-roberta",["XLMRobertaForMaskedLM",Ut]],["mobilebert",["MobileBertForMaskedLM",je]],["squeezebert",["SqueezeBertForMaskedLM",Ze]]]),ei=new Map([["bert",["BertForQuestionAnswering",q]],["roformer",["RoFormerForQuestionAnswering",K]],["electra",["ElectraForQuestionAnswering",ce]],["convbert",["ConvBertForQuestionAnswering",re]],["camembert",["CamembertForQuestionAnswering",fe]],["deberta",["DebertaForQuestionAnswering",xe]],["deberta-v2",["DebertaV2ForQuestionAnswering",Pe]],["mpnet",["MPNetForQuestionAnswering",Ye]],["albert",["AlbertForQuestionAnswering",ot]],["distilbert",["DistilBertForQuestionAnswering",Ee]],["roberta",["RobertaForQuestionAnswering",Lt]],["xlm",["XLMForQuestionAnswering",jt]],["xlm-roberta",["XLMRobertaForQuestionAnswering",Ht]],["mobilebert",["MobileBertForQuestionAnswering",Ge]],["squeezebert",["SqueezeBertForQuestionAnswering",et]]]),ti=new Map([["vision-encoder-decoder",["VisionEncoderDecoderModel",en]]]),ni=new Map([["vision-encoder-decoder",["VisionEncoderDecoderModel",en]]]),ri=new Map([["vit",["ViTForImageClassification",Qn]],["mobilevit",["MobileViTForImageClassification",tr]],["beit",["BeitForImageClassification",ar]],["deit",["DeiTForImageClassification",yr]],["convnext",["ConvNextForImageClassification",Rr]],["convnextv2",["ConvNextV2ForImageClassification",Gr]],["dinov2",["Dinov2ForImageClassification",Wr]],["resnet",["ResNetForImageClassification",vr]],["swin",["SwinForImageClassification",Sr]],["segformer",["SegformerForImageClassification",Ro]]]),oi=new Map([["detr",["DetrForObjectDetection",ur]],["table-transformer",["TableTransformerForObjectDetection",gr]],["yolos",["YolosForObjectDetection",Yr]]]),ii=new Map([["owlvit",["OwlViTForObjectDetection",or]]]),si=new Map([["detr",["DetrForSegmentation",dr]],["clipseg",["CLIPSegForImageSegmentation",hn]]]),ai=new Map([["segformer",["SegformerForSemanticSegmentation",jo]]]),li=new Map([["sam",["SamModel",Zr]]]),ci=new Map([["wav2vec2",["Wav2Vec2ForCTC",lo]],["wavlm",["WavLMForCTC",mo]],["hubert",["HubertForCTC",_o]]]),ui=new Map([["wav2vec2",["Wav2Vec2ForSequenceClassification",co]],["wavlm",["WavLMForSequenceClassification",bo]],["hubert",["HubertForSequenceClassification",ho]],["audio-spectrogram-transformer",["ASTForAudioClassification",Qt]]]),di=new Map([["vitmatte",["VitMatteForImageMatting",Zn]]]),pi=new Map([["swin2sr",["Swin2SRForImageSuperResolution",Fr]]]),_i=new Map([["dpt",["DPTForDepthEstimation",Er]],["glpn",["GLPNForDepthEstimation",Lr]]]),hi=[[Go,_],[Uo,h],[qo,m],[Yo,_],[Qo,_],[Ko,f],[Wo,f],[Zo,m],[Jo,_],[ei,_],[ti,g],[ri,_],[si,_],[ai,_],[di,_],[pi,_],[_i,_],[oi,_],[ii,_],[li,_],[ci,_],[ui,_],[Ho,f],[Xo,_]];for(const[e,t]of hi)for(const[n,r]of e.values())b.set(n,t),y.set(r,n),w.set(n,r);const fi=[["CLIPTextModelWithProjection",rn,_],["CLIPVisionModelWithProjection",on,_],["SiglipTextModel",ln,_],["SiglipVisionModel",cn,_],["ClapTextModelWithProjection",Do,_],["ClapAudioModelWithProjection",Lo,_]];for(const[e,t,n]of fi)b.set(e,n),y.set(t,e),w.set(e,t);class gi extends Vo{static MODEL_CLASS_MAPPINGS=[Go,Uo,qo];static BASE_IF_FAIL=!0}class mi extends Vo{static MODEL_CLASS_MAPPINGS=[Yo]}class bi extends Vo{static MODEL_CLASS_MAPPINGS=[Qo]}class wi extends Vo{static MODEL_CLASS_MAPPINGS=[Ko]}class yi extends Vo{static MODEL_CLASS_MAPPINGS=[Wo]}class xi extends Vo{static MODEL_CLASS_MAPPINGS=[Ho]}class Ti extends Vo{static MODEL_CLASS_MAPPINGS=[Xo]}class vi extends Vo{static MODEL_CLASS_MAPPINGS=[Zo]}class ki extends Vo{static MODEL_CLASS_MAPPINGS=[Jo]}class Mi extends Vo{static MODEL_CLASS_MAPPINGS=[ei]}class Si extends Vo{static MODEL_CLASS_MAPPINGS=[ti]}class Pi extends Vo{static MODEL_CLASS_MAPPINGS=[ri]}class Ai extends Vo{static MODEL_CLASS_MAPPINGS=[si]}class Fi extends Vo{static MODEL_CLASS_MAPPINGS=[ai]}class Ci extends Vo{static MODEL_CLASS_MAPPINGS=[oi]}class Oi extends Vo{static MODEL_CLASS_MAPPINGS=[ii]}class Ei extends Vo{static MODEL_CLASS_MAPPINGS=[li]}class Ii extends Vo{static MODEL_CLASS_MAPPINGS=[ci]}class Di extends Vo{static MODEL_CLASS_MAPPINGS=[ui]}class Li extends Vo{static MODEL_CLASS_MAPPINGS=[ni]}class $i extends Vo{static MODEL_CLASS_MAPPINGS=[di]}class Ni extends Vo{static MODEL_CLASS_MAPPINGS=[pi]}class zi extends Vo{static MODEL_CLASS_MAPPINGS=[_i]}class Bi extends z{constructor({logits:e,past_key_values:t,encoder_outputs:n,decoder_attentions:r=null,cross_attentions:o=null}){super(),this.logits=e,this.past_key_values=t,this.encoder_outputs=n,this.decoder_attentions=r,this.cross_attentions=o}}class Ri extends z{constructor({logits:e}){super(),this.logits=e}}class ji extends z{constructor({logits:e}){super(),this.logits=e}}class Vi extends z{constructor({logits:e}){super(),this.logits=e}}class Gi extends z{constructor({start_logits:e,end_logits:t}){super(),this.start_logits=e,this.end_logits=t}}class Ui extends z{constructor({logits:e}){super(),this.logits=e}}class qi extends z{constructor({logits:e,past_key_values:t}){super(),this.logits=e,this.past_key_values=t}}class Wi extends z{constructor({alphas:e}){super(),this.alphas=e}}class Hi extends z{constructor({waveform:e,spectrogram:t}){super(),this.waveform=e,this.spectrogram=t}}},"./src/pipelines.js":
/*!**************************!*\
  !*** ./src/pipelines.js ***!
